...
from ...models.get_manga_topics_filter import GetMangaTopicsFilter
...
def _get_kwargs(
    ...
    *,
    client: Client,
    filter_: Union[Unset, None, GetMangaTopicsFilter] = UNSET,
) -> Dict[str, Any]:
    url = "{}/manga/{id}/forum".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        filter_ (Union[Unset, None, GetMangaTopicsFilter]):
