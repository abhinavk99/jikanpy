...
class MangaSearch:
    ...
    Attributes:
        ...
        data (Union[Unset, List[Manga]]):
    """

    pagination: Union[Unset, PaginationPagination] = UNSET
    data: Union[Unset, List[Manga]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Manga.from_dict(data_item_data)
        ...
        manga_search.additional_properties = d
        return manga_search
