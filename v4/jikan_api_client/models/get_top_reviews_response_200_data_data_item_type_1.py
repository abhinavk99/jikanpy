...
T = TypeVar("T", bound="GetTopReviewsResponse200DataDataItemType1")


@attr.s(auto_attribs=True)
class GetTopReviewsResponse200DataDataItemType1:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_top_reviews_response_200_data_data_item_type_1 = cls(
            mal_id=mal_id,
            url=url,
            type=type,
            votes=votes,
        ...
        get_top_reviews_response_200_data_data_item_type_1.additional_properties = d
        return get_top_reviews_response_200_data_data_item_type_1
