...
T = TypeVar("T", bound="UserFavoritesDataMangaItem")


@attr.s(auto_attribs=True)
class UserFavoritesDataMangaItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_favorites_data_manga_item = cls(
            mal_id=mal_id,
            url=url,
            images=images,
            title=title,
        ...
        user_favorites_data_manga_item.additional_properties = d
        return user_favorites_data_manga_item
