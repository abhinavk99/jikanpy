...
T = TypeVar("T", bound="AnimeStatisticsDataScoresItem")
...
class AnimeStatisticsDataScoresItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anime_statistics_data_scores_item = cls(
            score=score,
            votes=votes,
            percentage=percentage,
        )

        anime_statistics_data_scores_item.additional_properties = d
        return anime_statistics_data_scores_item
