...
T = TypeVar("T", bound="AnimeStaffDataItemPerson")
...
class AnimeStaffDataItemPerson:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anime_staff_data_item_person = cls(
            mal_id=mal_id,
            url=url,
            images=images,
            name=name,
        ...
        anime_staff_data_item_person.additional_properties = d
        return anime_staff_data_item_person
