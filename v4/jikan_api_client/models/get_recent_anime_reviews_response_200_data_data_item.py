...
T = TypeVar("T", bound="GetRecentAnimeReviewsResponse200DataDataItem")


@attr.s(auto_attribs=True)
class GetRecentAnimeReviewsResponse200DataDataItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_recent_anime_reviews_response_200_data_data_item = cls(
            mal_id=mal_id,
            url=url,
            type=type,
            votes=votes,
        ...
        get_recent_anime_reviews_response_200_data_data_item.additional_properties = d
        return get_recent_anime_reviews_response_200_data_data_item
