...
T = TypeVar("T", bound="PeopleSearch")
...
class PeopleSearch:
    ...
    Attributes:
        ...
        data (Union[Unset, List[Person]]):
    """

    pagination: Union[Unset, PaginationPagination] = UNSET
    data: Union[Unset, List[Person]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Person.from_dict(data_item_data)
        ...
        people_search.additional_properties = d
