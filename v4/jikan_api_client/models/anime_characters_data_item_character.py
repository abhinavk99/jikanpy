...
T = TypeVar("T", bound="AnimeCharactersDataItemCharacter")
...
class AnimeCharactersDataItemCharacter:
    ...
    Attributes:
        ...
        name (Union[Unset, str]): Character Name
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anime_characters_data_item_character = cls(
            mal_id=mal_id,
            url=url,
            images=images,
            name=name,
        ...
        anime_characters_data_item_character.additional_properties = d
        return anime_characters_data_item_character
