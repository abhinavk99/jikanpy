...
T = TypeVar("T", bound="UsersTempDataItemMangaStats")
...
class UsersTempDataItemMangaStats:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_temp_data_item_manga_stats = cls(
            days_read=days_read,
        ...
        users_temp_data_item_manga_stats.additional_properties = d
        return users_temp_data_item_manga_stats
