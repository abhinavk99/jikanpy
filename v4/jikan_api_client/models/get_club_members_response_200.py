...
T = TypeVar("T", bound="GetClubMembersResponse200")


@attr.s(auto_attribs=True)
class GetClubMembersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_club_members_response_200 = cls(
            pagination=pagination,
            data=data,
        )

        get_club_members_response_200.additional_properties = d
        return get_club_members_response_200
