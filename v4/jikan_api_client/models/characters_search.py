...
T = TypeVar("T", bound="CharactersSearch")
...
class CharactersSearch:
    ...
    Attributes:
        ...
        data (Union[Unset, List[Character]]):
    """

    pagination: Union[Unset, PaginationPagination] = UNSET
    data: Union[Unset, List[Character]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Character.from_dict(data_item_data)

            data.append(data_item)

        characters_search = cls(
            pagination=pagination,
            data=data,
        )

        characters_search.additional_properties = d
        return characters_search
