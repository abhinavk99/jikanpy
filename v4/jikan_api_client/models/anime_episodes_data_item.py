...
T = TypeVar("T", bound="AnimeEpisodesDataItem")
...
class AnimeEpisodesDataItem:
    ...
    Attributes:
        ...
        forum_url (Union[Unset, None, str]): Episode discussion forum URL
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anime_episodes_data_item.additional_properties = d
        return anime_episodes_data_item
