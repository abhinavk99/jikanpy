...
class Magazines:
    ...
    Attributes:
        ...
        data (Union[Unset, List[Magazine]]):
    """

    pagination: Union[Unset, PaginationPagination] = UNSET
    data: Union[Unset, List[Magazine]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Magazine.from_dict(data_item_data)
        ...
        magazines.additional_properties = d
        return magazines
