...
T = TypeVar("T", bound="UsersTempDataItemAnimeStats")
...
class UsersTempDataItemAnimeStats:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_temp_data_item_anime_stats = cls(
        ...
        users_temp_data_item_anime_stats.additional_properties = d
        return users_temp_data_item_anime_stats
