...
class Producers:
    ...
    Attributes:
        ...
        data (Union[Unset, List[Producer]]):
    """

    pagination: Union[Unset, PaginationPagination] = UNSET
    data: Union[Unset, List[Producer]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Producer.from_dict(data_item_data)
        ...
        producers.additional_properties = d
        return producers
