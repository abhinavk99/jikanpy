...
from ..models.entry_meta import EntryMeta
from ..types import UNSET, Unset

T = TypeVar("T", bound="UsersTempDataItemFavorites")
...
class UsersTempDataItemFavorites:
    ...
    Attributes:
        anime (Union[Unset, List[EntryMeta]]): Favorite Anime
        manga (Union[Unset, List[EntryMeta]]): Favorite Manga
        characters (Union[Unset, List[EntryMeta]]): Favorite Characters
        people (Union[Unset, List[EntryMeta]]): Favorite People
    """

    anime: Union[Unset, List[EntryMeta]] = UNSET
    manga: Union[Unset, List[EntryMeta]] = UNSET
    characters: Union[Unset, List[EntryMeta]] = UNSET
    people: Union[Unset, List[EntryMeta]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for anime_item_data in _anime or []:
            anime_item = EntryMeta.from_dict(anime_item_data)
        ...
        for manga_item_data in _manga or []:
            manga_item = EntryMeta.from_dict(manga_item_data)
        ...
        for characters_item_data in _characters or []:
            characters_item = EntryMeta.from_dict(characters_item_data)
        ...
        for people_item_data in _people or []:
            people_item = EntryMeta.from_dict(people_item_data)

            people.append(people_item)

        users_temp_data_item_favorites = cls(
            anime=anime,
            manga=manga,
        ...
        users_temp_data_item_favorites.additional_properties = d
        return users_temp_data_item_favorites
