...
T = TypeVar("T", bound="CharacterAnimeDataItem")
...
class CharacterAnimeDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        character_anime_data_item = cls(
            role=role,
            anime=anime,
        )

        character_anime_data_item.additional_properties = d
        return character_anime_data_item
