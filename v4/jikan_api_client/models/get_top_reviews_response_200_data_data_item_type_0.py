...
T = TypeVar("T", bound="GetTopReviewsResponse200DataDataItemType0")


@attr.s(auto_attribs=True)
class GetTopReviewsResponse200DataDataItemType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_top_reviews_response_200_data_data_item_type_0 = cls(
            mal_id=mal_id,
            url=url,
            type=type,
            votes=votes,
        ...
        get_top_reviews_response_200_data_data_item_type_0.additional_properties = d
        return get_top_reviews_response_200_data_data_item_type_0
