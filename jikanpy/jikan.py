...
class Jikan(AbstractJikan):
    ...
    def _get(self, endpoint: str, id: int, extension: Optional[str], page: Optional[int] = None) -> Dict:
    ...
    def _get_creator(self, creator_type: str, creator_id: int, page: Optional[int] = None) -> Dict:
    ...
    def user(self, username: str, request: Optional[str] = None,
    ...
    def meta(self, request: str, type: Optional[str] = None, period: Optional[str] = None,
